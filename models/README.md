...
inputs the CLI builds into the model image. `reactor build` and `reactor run`
serve any of them on your own machine, and
[Build your own model](https://deploy-docs.reactor.inc/platform/build) explains
the workspace and manifest build definition they follow.
